...
class S {
  ...
  String loginTitle(String nameOfTheApp) {
    return Intl.message(
      ...
      name: 'loginTitle',
      desc:
          'The title people see when they open the app for the log in screen.',
      args: [nameOfTheApp],
    );
  }
  ...
  /// `{value} {value2, plural, =0{no comment} =1{comment} other{comments}}`
  String commentTitle(int value, num value2) {
    ...
    return Intl.message(
      '$valueString ${Intl.plural(value2, zero: 'no comment', one: 'comment', other: 'comments')}',
      name: 'commentTitle',
      desc: 'Anything you want',
